        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-nav ms-auto mb-lg-0">
                    <a class="nav-link" href="sulthon_login.php">Login</a>
                </div>
            </div>
        </div>
    </nav>
...
<form action ="form.php" method ="POST">
    <div class="row vh-50 align-items-center">
        <div class="col">
            <h1 style="text-align:left">Selamat Datang di Show Room MUHAMMAD FITRAH SULTHON</h1>
            ...
            <a type="submit" href="#" class="btn btn-primary" nama="BookNow">MyCar</a>
        ...
        <div class="col">
        <br><br><br><br><br><br><br><img src="fotomobil.jpg" class="card-img-top" alt="RUSH"><br><br><br><br><br><br><br>
        </div>
</form>